package org.linfa.micro.gate.server.filter;
...
import org.linfa.micro.auth.client.interceptor.ServiceFeignInterceptor;
...
import org.linfa.micro.common.msg.auth.TokenForbiddenResponse;
import org.linfa.micro.common.util.ClientUtil;
import org.linfa.micro.gate.server.feign.ILogService;
import org.linfa.micro.gate.server.feign.IUserService;
import org.linfa.micro.common.context.BaseContextHandler;
import org.linfa.micro.common.msg.auth.TokenErrorResponse;
...
public class AdminAccessFilter extends ZuulFilter {
    ...
    @PostConstruct
    public void init() {
        InstanceInfo prodSvcInfo = discoveryClient.getNextServerFromEureka("MICRO-ADMIN", false);
